...
public class YankSQLException extends RuntimeException {
  ...
  private static final String BEAN_EXCEPTION_MESSAGE =
      "Error converting row to bean!! Make sure you have a default no-args constructor!";
  ...
  public YankSQLException(SQLException sqlException, String poolName, String sql) {
    ...
    super(
        getSpecialMessage(sqlException)
            + "; "
